...
#SM=( 1762 1755 1747 1740 1732 1725 1717 1710 1702 1695 1687 1680 1672 1665 1657 1650 1642 1635 1627 1620 1612 1605 795 787 780 772 765 757 750 742 735 727 720 712 705 697 690 682 675 667 660 652 645 637 630 622 615 607 600 592 585 577 570 562 555 547 540 532 525 517 510 502 495 487 480 472 465 457 450 442 435 427 420 412)
SM=(420 412)
i=1

#================PTX & SASS
#PTX="/home/wwr/Desktop/EXEs/PTXs/ExeGM-joao"
#SASS="/home/wwr/Desktop/EXEs/SASSs/ExeGM-joao"
...
#================PROFILE related
PROF="/home/wwr/Desktop/EXEs/PROFs/ExeGM-joao/"
...
ENERGY="/home/wwr/Desktop/EXEs/ENERGYs/ExeGM-joao/"

for sm_freq in  ${SM[@]};do
        sudo nvidia-smi -lgc $sm_freq
        for file in *.out;do
            efilename=$ENERGY"power_samples_"$file"_freq_"$sm_freq"_time_"$i".csv" 
            $PM 2 > $efilename &
            PM_PID=$!
            ./$file
            sleep 1
