...
#================PTX & SASS
PTX="/home/wwr/Desktop/EXEs/PTXs/ExeGM-akhi-DM4"
SASS="/home/wwr/Desktop/EXEs/SASSs/ExeGM-akhi-DM4"
...
#================PROFILE related
PROF="/home/wwr/Desktop/EXEs/PROFs/ExeGM-akhi-DM4/"
...
for sm_freq in  ${SM[@]};do
    ...
    for file in *.out;do
        $ncu_pre $PROF"ncuprof_output_"$file"_freq_"$sm_freq $ncu_param ./$file $NumCTA $NumThd $NumIter 32 1 >/dev/null 2>&1	
...
ENERGY="/home/wwr/Desktop/EXEs/ENERGYs/ExeGM-akhi-DM4/"
...
for sm_freq in  ${SM[@]};do
        ...
        for file in *.out;do
            ...
            $PM 2 > $efilename &
            PM_PID=$!
            ./$file $NumCTA $NumThd $NumIter 32 1 
            sleep 1
